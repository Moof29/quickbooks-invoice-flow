-- Fix order generation: selected date should be both invoice_date and delivery_date
...
BEGIN
  ...
  created_invoices AS (
    ...
    SELECT 
      ...
      inv.invoice_number,
      'pending',
      inv.target_date,  -- CHANGED: Use target_date instead of CURRENT_DATE
      inv.target_date,  -- delivery_date (same as order_date)
