    ...
    return (
      <div className="container mx-auto p-6">
        <div className="text-center">
          ...
          <p className="text-muted-foreground mb-4">The requested sales order could not be found.</p>
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                {editMode ? (
                  ...
                  <p className="mt-1 text-sm whitespace-pre-wrap">{salesOrder.memo || '-'}</p>
                )}
              </div>
              ...
              <div>
                ...
                {editMode ? (
                  ...
                  <p className="mt-1 text-sm whitespace-pre-wrap">{salesOrder.message || '-'}</p>
                )}
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-2">
                ...
                <div className="flex justify-between">
                  <span>Tax</span>
                  <span>${salesOrder.tax_total?.toFixed(2) || '0.00'}</span>
                </div>
                <div className="flex justify-between">
                  <span>Shipping</span>
                  <span>${salesOrder.shipping_total?.toFixed(2) || '0.00'}</span>
                </div>
                <div className="flex justify-between">
                  <span>Discount</span>
                  <span>-${salesOrder.discount_total?.toFixed(2) || '0.00'}</span>
                </div>
                <Separator />
